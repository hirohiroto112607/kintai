...
/* セカンダリーホバー */
.employee-nav .button.secondary:hover {
  background: #ced4da;
}

/* 各ボタンにカラフルな色を割り当て */
.employee-nav input[value="出勤"] {
  background: linear-gradient(135deg, #4caf50 0%, #388e3c 100%); /* 緑 */
  color: #fff;
}
.employee-nav input[value="出勤"]:hover {
  background: linear-gradient(135deg, #388e3c 0%, #2e7d32 100%);
}

.employee-nav input[value="退勤"] {
  background: linear-gradient(135deg, #f44336 0%, #d32f2f 100%); /* 赤 */
  color: #fff;
}
.employee-nav input[value="退勤"]:hover {
  background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%);
}

.employee-nav a[href*="qr"] {
  background: linear-gradient(135deg, #4caf50 0%, #388e3c 100%); /* 緑 */
  color: #fff;
}
.employee-nav a[href*="qr"]:hover {
  background: linear-gradient(135deg, #388e3c 0%, #2e7d32 100%);
}

.employee-nav a[href*="face/attendance"] {
  background: linear-gradient(135deg, #ff9800 0%, #f57c00 100%); /* オレンジ */
  color: #fff;
}
.employee-nav a[href*="face/attendance"]:hover {
  background: linear-gradient(135deg, #f57c00 0%, #ef6c00 100%);
}

.employee-nav a[href*="nfc_attendance"] {
  background: linear-gradient(135deg, #9c27b0 0%, #7b1fa2 100%); /* 紫 */
  color: #fff;
}
.employee-nav a[href*="nfc_attendance"]:hover {
  background: linear-gradient(135deg, #7b1fa2 0%, #6a1b9a 100%);
}

.employee-nav a[href*="leave-requests"] {
  background: linear-gradient(135deg, #e91e63 0%, #c2185b 100%); /* ピンク */
  color: #fff;
}
.employee-nav a[href*="leave-requests"]:hover {
  background: linear-gradient(135deg, #c2185b 0%, #ad1457 100%);
}

.employee-nav a[href*="passkey_register"] {
  /* デフォルトのまま */
}

.employee-nav a[href*="face/manage"] {
  background: linear-gradient(135deg, #2196f3 0%, #1976d2 100%); /* 青 */
  color: #fff;
}
.employee-nav a[href*="face/manage"]:hover {
  background: linear-gradient(135deg, #1976d2 0%, #1565c0 100%);
}

.employee-nav a[href*="face/authenticate"] {
  background: linear-gradient(135deg, #f44336 0%, #d32f2f 100%); /* 赤 */
  color: #fff;
}
.employee-nav a[href*="face/authenticate"]:hover {
  background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 100%);
}

/* フォーカス状態（アクセシビリティ） */
.employee-nav .button:focus {
