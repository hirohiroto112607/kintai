...
public class UserDAO {
    ...
    public User findByUsername(String username) {
        String sql = "SELECT username, password, role, department_id, enabled FROM users WHERE username = ?";
    ...
    public Collection<User> getAllUsers() {
        ...
        String sql = "SELECT username, password, role, department_id, enabled FROM users ORDER BY username";
    ...
    public void addUser(User user) {
        String sql = "INSERT INTO users (username, password, role, department_id, enabled) VALUES (?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DatabaseUtil.getConnection();
            ...
            stmt.setString(4, user.getDepartmentId());
    ...
    public void updateUser(User user) {
        String sql = "UPDATE users SET password = ?, role = ?, department_id = ?, enabled = ? WHERE username = ?";
        ...
        try (Connection conn = DatabaseUtil.getConnection();
            ...
            stmt.setString(3, user.getDepartmentId());
